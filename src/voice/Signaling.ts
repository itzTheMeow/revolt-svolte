...
export default class Signaling extends EventEmitter<SignalingEvents> {
  ...
  initializeTransports(rtpCapabilities: RtpCapabilities): Promise<TransportInitDataTuple> {
  ...
  async startProduce(type: ProduceType, rtpParameters: RtpParameters): Promise<string> {
